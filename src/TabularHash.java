...
public class TabularHash extends Hash {
    ...
    /**
     * Build table if not built and generate hash value for a key by peforming
     * the XOR operation on the splits (chunks) for a key.
     * 
     * @param k
     *            key
     * @param m
	...
	TabularHash hash = new TabularHash(32, 2 << 20 - 1);
